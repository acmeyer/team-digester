...
githubWebhooks.on('installation.deleted', async ({ id, name, payload }) => {
  logger.info('installation.deleted callback', id, name, payload, { structuredData: true });
  const { installation } = payload;
...
githubWebhooks.on('push', async ({ id, name, payload }) => {
  logger.info('push callback', id, name, payload, { structuredData: true });
...
githubWebhooks.on('pull_request', async ({ id, name, payload }) => {
  logger.info('pull_request callback', id, name, payload, { structuredData: true });
...
githubWebhooks.on('pull_request_review_comment', async ({ id, name, payload }) => {
  logger.info('pull_request_review_comment callback', id, name, payload, { structuredData: true });
...
githubWebhooks.on('pull_request_review', async ({ id, name, payload }) => {
  logger.info('pull_request_review callback', id, name, payload, { structuredData: true });
...
githubWebhooks.on('pull_request_review_thread', async ({ id, name, payload }) => {
  logger.info('pull_request_review_thread callback', id, name, payload, { structuredData: true });
...
githubWebhooks.on('release', async ({ id, name, payload }) => {
  logger.info('release callback', id, name, payload, { structuredData: true });
...
githubWebhooks.on('issue_comment', async ({ id, name, payload }) => {
  logger.info('issue_comment callback', id, name, payload, { structuredData: true });
...
githubWebhooks.on('issues', async ({ id, name, payload }) => {
  logger.info('issues callback', id, name, payload, { structuredData: true });
...
githubWebhooks.on('commit_comment', async ({ id, name, payload }) => {
  logger.info('commit_comment callback', id, name, payload, { structuredData: true });
